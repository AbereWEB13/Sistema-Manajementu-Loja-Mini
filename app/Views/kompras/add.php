        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Aumenta Kompras</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('kompras/store') ?>" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="basic-default-company" placeholder="Kode ..." name="kode_kompras" value="<?= old('kode_Kompras') ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="data_kompras">
                                        <i class="fa-solid fa-calendar-days me-2"></i> Data Kompras
                                    </label>
                                    <input type="date" class="form-control" id="basic-default-company" placeholder="Naran Sub-fornesedor.." name="data_kompras" value="<?= old('data_kompras') ?>">
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="id_fornesedor">
                                        <?php foreach ($fornesedor as $key => $row): ?>
                                            <option value="<?= $row['id_fornesedor']; ?>"><?= $row['naran_fornesedor']; ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="mb-3">
