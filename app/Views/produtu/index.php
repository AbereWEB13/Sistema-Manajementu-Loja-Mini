            ...
            <div class="card">
                <div class="card-header">
                    <div class="section-header-button">
                        <a href="<?= base_url('produtu/add') ?>" class="btn btn-outline-primary">
                            <i class="bx bx-plus"></i> Aumenta Produtu
                        </a>
                        <a href="<?= base_url('produtu/print'); ?>" class="btn btn-outline-secondary ms-2">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?= base_url('produtu/edit/' . $row['id_produtu']) ?>"><i class=" icon-base bx bx-edit-alt me-1"></i> Hadia</a>
                                                        <a class="dropdown-item" id="btn-hamos" href="<?= base_url('/produtu/delete/' . $row['id_produtu']) ?>"><i class="icon-base bx bx-trash me-1"></i> Apaga</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
